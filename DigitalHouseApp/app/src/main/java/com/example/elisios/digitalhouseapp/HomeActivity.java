...
public class HomeActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, PostsFragment.PostClicado {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView texto = navigationView.getHeaderView(0).findViewById(R.id.textView);
